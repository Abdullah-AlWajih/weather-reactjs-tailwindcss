        ...
        <div className='bg-gray-800 h-screen grid place-items-center'>
            <div className='bg-white dark:bg-slate-800 w-96 p-4 rounded-md'>
                <div className="flex">
                    ...
                    <button onClick={fetchWeather} className='inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600'>
